...
const testimonials = [
  { name: "Gaurav G.", role: "Career Coach", text: "Every detail was handled perfectly — transitions, color correction, everything. My video looks truly professional now." },
  { name: "Madhav J.", role: "Tech Creator", text: "Fast delivery with excellent quality. Even with tight deadlines, everything was managed smoothly." },
  { name: "Payal S.", role: "Travel Vlogger", text: "My content quality improved dramatically. Audience engagement shot up. The creativity is unmatched." },
  { name: "Mansi C.", role: "Lifestyle Creator", text: "Top-notch quality, speed, and creativity. One of the best editing experiences I've had." },
  { name: "Ruchi S.", role: "Food Blogger", text: "Outstanding attention to detail. Every frame looks polished. Delivery was on time and communication was smooth." },
  { name: "Shruti J.", role: "Speaker", text: "Raw footage transformed into an engaging video. Transitions, color grading, and music sync — all perfect." },
];
        ...
        <div className="w-full overflow-hidden">
          <div className="flex animate-marquee" style={{ width: "200%" }}>
            {[...testimonials, ...testimonials].map((t, i) => (
              <div
                key={i}
                className="flex-shrink-0 mx-2 md:mx-3 w-[280px] md:w-[360px] glass-card rounded-2xl p-5 md:p-7 hover:border-glow transition-colors"
              >
