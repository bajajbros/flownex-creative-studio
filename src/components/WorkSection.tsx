  ...
  return (
    <section id="work" className="py-20 md:py-28 px-4 md:px-6">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <div>
            <p className="text-primary text-xs md:text-sm font-semibold uppercase tracking-[0.25em] mb-3">Portfolio</p>
            <h2 className="text-3xl md:text-5xl lg:text-6xl font-extrabold tracking-tight">
              Selected <span className="italic font-light text-foreground/70">Work</span>
            </h2>
          </div>
